...
class Botphonic_Widget_Icon_Box extends Widget_Icon_Box
{
    protected function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'options' => [
                    'title_left' => [
                        'title' => esc_html__('Title Left', 'elementor'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'condition' => [
                    'selected_icon[value]!' => '',
                    'position' => ['title_left', 'left', 'right'],
                ],
            ]
        );
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type(new Botphonic_Widget_Icon_Box());
