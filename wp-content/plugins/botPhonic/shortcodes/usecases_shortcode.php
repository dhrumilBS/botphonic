						...
						<?php foreach ($botphonic_usecases as $item) { ?>
							<div class="swiper-slide">
								<div class="usecase-card">
									<div data-element="audio-btn" class="usecase-header <?= $item['gradient_class']; ?>" data-audio="<?= site_url(); ?>/wp-content/plugins/botPhonic/assets/wav/<?= $item['file']; ?>">
										<div class="mb-3">
											<div class="is-soundwaves mx-auto">
										...
										<div class="usecase-body">
											...
											<div class="usecase-try-btn align-items-center ms-auto">
			...
			<div>
				...
				$features = [
					...
					[
						...
						"desc" => "Zero wait times"
					],
					[
						"icon" => "check-circle",
						"title" => "95% accuracy",
						"desc" => "Human-like understanding"
					]
				];
				?>
				<div class="botphonic-features">
					<?php foreach ($features as $feature): ?>
						<div class="botphonic-card">
							<div class="botphonic-card-inner">
								<div class="botphonic-icon">
								...
								<div class="botphonic-content">
									<div class="h3"><?= $feature["title"] ?></div>
									<p><?= $feature["desc"] ?></p>
								</div>
							</div>
						</div>
