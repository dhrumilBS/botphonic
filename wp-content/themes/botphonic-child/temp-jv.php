...
<?php if (1 == 1) :  ?>
    ...
    <section class="hero-section position-relative overflow-hidden custom-bg-gradient">
        ...
        <div class="container py-5 text-center position-relative z-1">
            ...
            <!-- Heading -->
            <h1 class="mb-3">
                <span class="custom-text-gradient">Revolutionary AI</span><br />
                Call Assistant<br />
                <span class="fs-3 text-primary">JV Launch</span>
            </h1>
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-center align-items-center gap-3 mb-4">
                <div class="d-flex align-items-center text-success gap-2 fw-semibold">
                ...
                <div class="d-none d-sm-block bg-primary rounded-circle" style="width: 6px; height: 6px;"></div>
                <div class="text-warning fw-semibold">50% Commission + Bonuses</div>
            </div>
    ...
    <section class="botphonic-liveDemo-section position-relative section-padded custom-bg-background">
            ...
            <div class="mx-auto" style="max-width: 1200px;">
                <div class="card border-1 shadow-lg rounded-4 overflow-hidden">
                    ...
                    <div class="ratio ratio-16x9">
                        <iframe
                            src="https://app.botphonic.ai/voice-assistant"
                            class="border-0"
                            allowfullscreen
                            title="Botphonic AI Voice Assistant Demo"></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-5 bg-light affiliate-benefits-section">
        <div class="container">
            <!-- Section Heading -->
            <div class="text-center mb-5">
                <h2 class="mb-3">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 shadow-sm border border-light transition-scale hover-shadow">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="text-muted">
                                Earn 50% on front-end + all upsells. Average order value $297. Top affiliates earning $50K+ in launch week alone.
                            </p>
                        </div>
                    </div>
                </div>
...
<style>
    .custom-gradient-text {
        background: linear-gradient(to right, hsl(215, 100%, 47%), hsl(278, 52%, 47%));
...
<section class="botphonic-meet-section py-5 bg-light">
    <div class="container px-3">
        <div class="text-center mb-5">
            ...
            <div class="col-lg-6 text-center">
                <div class="position-relative d-inline-block">
                    <div class="card p-4 rounded-4 border shadow-lg custom-animate-float">
                        <div class="rounded-circle text-white d-flex align-items-center justify-content-center mx-auto mb-4" style="width:64px; height:64px;">
                    ...
                    <div class="position-absolute bottom-0 start-0 translate-middle bg-warning text-white p-3 rounded-3"><small>&lt;2s</small><br><small>Response</small></div>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-5 position-relative bg-light overflow-hidden" style="background: linear-gradient(to bottom right, rgba(0, 123, 255, 0.05), transparent, rgba(255, 193, 7, 0.05)); z-index: 0;">
    ...
    <div class="container position-relative text-center">
        ...
        <div class="mx-auto" style="max-width: 960px;">
            <div class="position-relative p-5 p-md-5 bg-white border rounded-4 shadow">
                <div class="row mb-4">
                ...
                <div class="text-center">
                    <a href="#" class="theme-btn px-5 py-3 d-inline-flex align-items-center gap-2 shadow">
...
<!-- <section class="section-padded bg-gradient-to-br from-primary/5 via-purple-500/5 to-pink-500/5 relative overflow-hidden">
    <div class="container mx-auto px-6 text-center">
        <div class="max-w-4xl mx-auto">
            <div class="flex justify-center mb-8">
                <div class="flex items-center gap-3 bg-primary/10 backdrop-blur-sm rounded-full px-8 py-4 border border-primary/20">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="  text-yellow-600 animate-pulse">
                        <circle cx="12" cy="12" r="10">
                    ...
                    <span class="text-foreground font-bold text-lg">Launch Starts February 5th</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="  text-primary">
            ...
            <h2 class="text-5xl md:text-7xl font-bold text-foreground mb-8 leading-tight">Ready to<br>
                <span class="bg-gradient-to-r from-primary via-purple-600 to-yellow-600 bg-clip-text text-transparent">Dominate</span>
                <br>This Launch?
            </h2>
            <p class="text-xl md:text-2xl text-muted-foreground mb-12 leading-relaxed-sans">Join the most profitable AI affiliate launch of 2025. Limited JV spots available.<br>
                <span class="text-yellow-600 font-semibold">Don't miss your chance to earn $50K+ in one week!</span>
            </p>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <div class="bg-green-600/10 backdrop-blur-sm rounded-2xl p-6 border border-green-600/20">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="-sign w-12 h-12 text-green-600 mx-auto mb-4">
                    ...
                    <div class="text-2xl font-bold text-foreground mb-2">50% Commission</div>
                    <div class="text-muted-foreground-sans">On all products + bonuses</div>
                </div>
                <div class="bg-primary/10 backdrop-blur-sm rounded-2xl p-6 border border-primary/20">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class=" w-12 h-12 text-primary mx-auto mb-4">
                        <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2">
                    ...
                    <div class="text-2xl font-bold text-foreground mb-2">Full Support</div>
                    <div class="text-muted-foreground-sans">Dedicated affiliate manager</div>
                </div>
                <div class="bg-yellow-600/10 backdrop-blur-sm rounded-2xl p-6 border border-yellow-600/20">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class=" w-12 h-12 text-yellow-600 mx-auto mb-4">
                        <path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z">
                    ...
                    <div class="text-2xl font-bold text-foreground mb-2">Proven Funnel</div>
                    <div class="text-muted-foreground-sans">12% conversion rate</div>
                </div>
            </div>
            <div class="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <button class="inline-flex items-center justify-center gap-2 whitespace-nowrap ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 bg-primary text-primary-foreground hover:bg-primary/90 h-11 w-full sm:w-auto px-12 py-6 text-2xl font-bold rounded-2xl shadow-lg transition-all duration-300 transform hover:scale-105">🚀 GET AFFILIATE LINK NOW</button>
                <button class="inline-flex items-center justify-center gap-2 whitespace-nowrap ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-11 w-full sm:w-auto px-12 py-6 text-2xl font-bold rounded-2xl transition-all duration-300 transform hover:scale-105">📧 Get Swipes &amp; Resources</button>
            </div>
            <div class="mt-8 text-center">
                <p class="text-muted-foreground-sans">Questions? Email: <span class="text-primary font-semibold">jv@Botphonic.com</span>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container px-4">
        ...
        <div class="text-center">
            <p class="text-muted mb-0">
                ...
                <span class="text-primary fw-semibold ms-1">JV Launch Partnership Program</span>
            </p>
        </div>
