...
<style>
    ...
    .title span {
        background-image: linear-gradient(304deg, #FF37DF 21.73%, #6E00FF 56.6%);
    }

    .hero-section {
        background-image: radial-gradient(ellipse at 50% -10%, #ffffff 0%, transparent 85%), radial-gradient(circle at 100% 5%, #D6E7FF, transparent 0%), radial-gradient(circle at 10% 8%, #F9E4FE, transparent 11%), linear-gradient(#D6E7FF 0%, #f3f9fe 20%);
    }

    #shortPlanContainer .short-plan-card {
        border: 2px solid #fff;
        display: flex;
        flex-direction: column;
        background: linear-gradient(0deg, #f5f6fe, #fff2);
        border-radius: 20px;
        padding: 1.5rem;
    ...
    #shortPlanContainer .short-plan-card:hover {
        box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);
        border-color: #4f46e5;
    }

    #shortPlanContainer .short-plan-strike {
        text-decoration: line-through;
        color: #888;
        font-size: 0.9rem;
    }

    #shortPlanContainer .short-plan-final {
        font-weight: 500;
        font-size: 1.2rem;
    }

    #shortPlanContainer .short-plan-badge {
        background: #28a745;
        color: white;
        padding: 4px 10px;
        border-radius: 12px;
    ...
    #shortPlanContainer .short-plan-main-features {
        list-style: none;
        padding: 0;
        flex-grow: 1;
        margin: 1rem 0 0;
    ...
    #shortPlanContainer .short-plan-feature-item {
        display: flex;
    ...
    #shortPlanContainer .short-plan-feature-item .check-icon {
        display: inline-block;
        width: 18px;
        height: 18px;
        margin-right: 4px;
    ...
    #shortPlanContainer .short-plan-btn {
        margin-top: 10px;
        padding: 6px 14px;
        border-radius: 6px;
        cursor: pointer;
    ...
    <div class="container">
        ...
        <div class="hero-pricing section-padded">
            <div class="container">
                ...
                <div class="short-plan-header billing-currency-wrap text-center">
                    ...
                    <div class="d-flex align-items-center justify-content-center gap-2">
                        <div class="d-flex align-items-center fw-semibold small gap-2">
                            <div id="monthlyBtn" data-period="Monthly" class="text-dark text-decoration-none">Monthly</div>

                            <div class="position-relative bg-dark rounded-pill" style="width: 28px; height: 16px;">
                                <span id="billingToggle" class="position-absolute bg-white rounded-circle"
                                    style="width: 12px; height: 12px; top: 50%; left: 14px; transform: translateY(-50%); transition: left 0.3s;"></span>
                            </div>

                            <div id="yearlyBtn" data-period="Yearly" class="text-dark text-decoration-none d-flex align-items-center gap-3">
                                Yearly
                ...
                <!-- Short Plans Display -->
                <div id="shortPlanContainer" class="short-plan-list mobile-wrap row flex-sm-nowrap row-cols-1 row-cols-md-2 row-cols-lg-4 mt-4 g-4 gm-md-0">
                    <div class="col">
                        <div class="short-plan-card pricing-card">
                            <div class="short-plan-header">
                                <h4 class="short-plan-title">Pro</h4>

                                <div class="short-plan-price">
                                    <div class="short-plan-final">USD 290.00<small>/mo</small></div>
                                    <span class="d-inline short-plan-strike old-price">USD 350.00</span>
                                </div>
                            </div>
                            <ul class="short-plan-main-features">
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> 2,000 mins, then $0.13/min</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> 25 Concurrent Calls</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> 8,000 Custom Workflows</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> Team Access</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> Support via Ticketing</li>
                            </ul><a href="https://app.botphonic.ai/register/" target="_blank" class="theme-btn short-plan-btn">Select</a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="short-plan-card pricing-card">
                            <div class="short-plan-header">
                                <h4 class="short-plan-title">Growth</h4>

                                <div class="short-plan-price">
                                    <div class="short-plan-final">USD 580.00<small>/mo</small></div>
                                    <span class="d-inline short-plan-strike old-price">USD 700.00</span>
                                </div>
                            </div>
                            <ul class="short-plan-main-features">
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> 4,000 mins, then $0.12/min</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> 50 Concurrent Calls</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> 42,000 Custom Workflows</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> 25 Subaccounts</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> Everything in Pro</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> Rebilling</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> Access to New Features</li>
                            </ul><a href="https://app.botphonic.ai/register/" target="_blank" class="theme-btn short-plan-btn">Select</a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="short-plan-card pricing-card">
                            <div class="short-plan-header">
                                <h4 class="short-plan-title">Agency</h4>

                                <div class="short-plan-price">
                                    <div class="short-plan-final">USD 1020.00<small>/mo</small></div>
                                    <span class="d-inline short-plan-strike old-price">USD 1150.00</span>
                                </div>
                            </div>
                            <ul class="short-plan-main-features">
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> 6,000 mins, then $0.12/min</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> 80 Concurrent Calls</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> 100,000 Custom Workflows</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> Unlimited Subaccounts</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> White Label Platform</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> 30-Day Onboarding &amp; Private Slack Channel</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> Support via Ticketing</li>
                            </ul><a href="https://app.botphonic.ai/register/" target="_blank" class="theme-btn short-plan-btn">Select</a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="short-plan-card pricing-card">
                            <div class="short-plan-header">
                                <h4 class="short-plan-title">Enterprise</h4>
                            ...
                            <ul class="short-plan-main-features">
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> Volume-based Price, as low as $0.08/min</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> SIP Trunk Integration</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> Guaranteed Uptime (SLA)</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> Custom Integrations</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> 200+ Concurrent Calls</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> Compliance (SOC2, HIPAA, GDPR)</li>
                                <li class="short-plan-feature-item"><span class="check-icon">✔</span> Enterprise Onboarding, Training, Support</li>
                            </ul><a href="https://app.botphonic.ai/register/" target="_blank" class="theme-btn short-plan-btn">Select</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="row justify-content-center text-center g-4">
            ...
            <div class="col-md-4">
                <div class="mx-auto mb-4 rounded-circle d-flex align-items-center justify-content-center bg-gradient-primary" style="width: 64px; height: 64px;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-message-square">
            ...
            <div class="col-md-4">
                <div class="mx-auto mb-4 rounded-circle d-flex align-items-center justify-content-center bg-gradient-primary" style="width: 64px; height: 64px;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-headphones">
